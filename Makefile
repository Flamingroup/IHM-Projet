...
# Generated by qmake (2.01a) (Qt 4.8.6) on: dim. févr. 23 09:10:03 2014
# Project:  IHM.pro
# Template: app
...
SOURCES       = 3rdparty/qextserialport/src/qextserialport.cpp \
		...
		mainwindow.cpp \
		portselection.cpp \
		plot.cpp moc_qextserialenumerator.cpp \
		moc_mainwindow.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/IHM1.0.0/ && $(COPY_FILE) --parents 3rdparty/qextserialport/src/qextserialport.h 3rdparty/qextserialport/src/qextserialport_p.h 3rdparty/qextserialport/src/qextserialenumerator.h 3rdparty/qextserialport/src/qextserialenumerator_p.h 3rdparty/qextserialport/src/qextserialport_global.h mainwindow.h portselection.h plot.h .tmp/IHM1.0.0/ && $(COPY_FILE) --parents 3rdparty/qextserialport/src/qextserialport.cpp 3rdparty/qextserialport/src/qextserialenumerator.cpp 3rdparty/qextserialport/src/qextserialport_unix.cpp 3rdparty/qextserialport/src/qextserialenumerator_unix.cpp main.cpp mainwindow.cpp portselection.cpp plot.cpp .tmp/IHM1.0.0/ && (cd `dirname .tmp/IHM1.0.0` && $(TAR) IHM1.0.0.tar IHM1.0.0 && $(COMPRESS) IHM1.0.0.tar) && $(MOVE) `dirname .tmp/IHM1.0.0`/IHM1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/IHM1.0.0
